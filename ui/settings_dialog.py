...
class SettingsDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        # Preview label
        self.preview_label = QLabel("Preview: Sample Text 預覽文字")
    ...
    def _create_scale_section(self) -> QGroupBox:
        ...
        # Scale description
        desc = QLabel("Adjusts the overall size of interface elements (50% - 200%)")
    ...
    def _create_text_size_section(self) -> QGroupBox:
        ...
        desc = QLabel("Adjusts text size across the application (-10 to +10 points)")
        desc.setStyleSheet("color: #AAAAAA; font-size: 10px;")
        desc.setWordWrap(True)
