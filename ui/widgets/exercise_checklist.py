...
from PyQt6.QtWidgets import (
    ...
    QFormLayout, QSpinBox, QComboBox, QTextEdit
)
...
class ExerciseChecklistWidget(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self.refresh_button.setMinimumWidth(200)  # Larger button
        self.refresh_button.setMinimumHeight(50)  # Larger button
    ...
    def _add_exercise_item(self, exercise: Exercise, log: ExerciseLog) -> None:
        ...
        # Row 1: Checkbox + Name + Edit button
        top_row = QHBoxLayout()
        ...
        edit_button = QPushButton("⋯")  # Three dots character
        ...
        list_item.setSizeHint(QSize(0, 80))  # Set fixed height for exercise items
    ...
    def _update_summary(
        ...
        summary_text = (
            f"完成率: {completed}/{total} exercises ({completion_pct:.0f}%)  |  "
            f"總進度: {total_actual}/{total_target}"
        )
