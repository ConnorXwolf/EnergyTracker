...
class RingChartWidget(QWidget):
    ...
    def update_from_points(self, points: dict) -> None:
        ...
        Args:
        points: Dictionary with 'physical', 'mental' keys (each 0-50)
        """
        self._manual_points = points
    
        # Calculate HP: physical + mental (direct sum, 0-100 range)
        raw_hp = points['physical'] + points['mental']
        hp = 20 + (raw_hp * 4)  # Normalize to 0-100%
        ...
        total_points = points['physical'] + points['mental']
